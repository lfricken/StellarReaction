    ...
    class TGUI_API ClickableWidget : public Widget
    {
      ...
      public:
        ...
        enum ClickableWidgetCallbacks
        {
			...
			RightMousePressed             = WidgetCallbacksCount * 8,  
			RightMouseReleased            = WidgetCallbacksCount * 16,  
			RightMouseClicked             = WidgetCallbacksCount * 32,    
            AllClickableWidgetCallbacks   = WidgetCallbacksCount * 64 - 1, ///< All triggers defined in ClickableWidget and its base classes
            ClickableWidgetCallbacksCount = WidgetCallbacksCount * 64
        };
