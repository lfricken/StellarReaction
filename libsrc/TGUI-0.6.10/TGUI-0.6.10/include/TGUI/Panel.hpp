...
namespace tgui
{
    ...
    class TGUI_API Panel : public Container
    {
      public:
		...
		/// \internal
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual void rightMousePressed(float x, float y);

		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/// \internal
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual void rightMouseReleased(float x, float y);
      ...
      public:
        ...
        enum PanelCallbacks
		{
			...
			RightMousePressed = WidgetCallbacksCount * 8,      ///< The right mouse button was pressed
			RightMouseReleased = WidgetCallbacksCount * 16,     ///< The right mouse button was released
			RightMouseClicked = WidgetCallbacksCount * 32,      ///< The right mouse button was clicked
            AllPanelCallbacks = WidgetCallbacksCount * 64 - 1, ///< All triggers defined in Panel and its base classes
            PanelCallbacksCount = WidgetCallbacksCount * 64
        };
