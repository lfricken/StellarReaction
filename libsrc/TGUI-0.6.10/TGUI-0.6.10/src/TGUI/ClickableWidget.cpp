...
namespace tgui
{
	...
	void ClickableWidget::rightMousePressed(float x, float y)
	{
		// Set the mouse down flag
		m_MouseDown = true;

		// Add the callback (if the user requested it)
		if(m_CallbackFunctions[RightMousePressed].empty() == false)
		{
	...
	void ClickableWidget::rightMouseReleased(float x, float y)
	{
		// Add the callback (if the user requested it)
		if(m_CallbackFunctions[RightMouseReleased].empty() == false)
		{
		...
		{
			// Add the callback (if the user requested it)
			if(m_CallbackFunctions[RightMouseClicked].empty() == false)
			{
