...
public:
	...
	std::vector<std::string> getAllFiles(const std::string& rDir, bool(*evalFunc)(const std::string& extensionName) = NULL) const;
	/// <summary>
	/// Gets all files in a relative directory.
	/// </summary>
	/// <param name="rDir">The starting directory.</param>
	...
	std::vector<std::string> getAllFiles(const std::string& rDir, const std::string& extension) const;	
	/// <summary>
